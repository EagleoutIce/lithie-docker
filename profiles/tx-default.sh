tlmgr install latexmk biblatex biber bibtex8 texdef \
    ...
    cmextra courier euro eurosym helvetic marvosym tipa tex-gyre wasy wasy-type1 wasysym cyrillic biblatex-ieee cfr-initials newtx ccicons mathdesign chessfss eulervm skak
